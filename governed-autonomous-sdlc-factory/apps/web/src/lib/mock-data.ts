...
// ─── Architecture ─────────────────────────────────────────────────────
import type { TraceabilityLink, GovernanceEvaluation, ArtifactItem } from '@/lib/api';
...
export const mockArchComponents: ArchComponent[] = [
  { id: 'comp-api-gateway', name: 'API Gateway', type: 'api', status: 'verified', dependencies: [], tokenCost: 4200, changeFrequency: 1, testCoverage: 0.95, traceabilityLinks: { incoming: [], outgoing: [{ id: 'tl-1', run_id: 'run-001', source_type: 'component', source_id: 'comp-api-gateway', target_type: 'component', target_id: 'comp-auth-svc', link_type: 'calls', confidence: 0.95 }] }, governanceEvaluations: [{ id: 'gov-1', run_id: 'run-001', policy_id: 'pol-auth', policy_name: 'Auth Enforcement', status: 'pass', severity: 'info', findings: [], input_data: {} }], artifacts: [{ id: 'art-1', run_id: 'run-001', type: 'openapi', name: 'api-gateway-spec.yaml', metadata: {} }], riskScore: 0.1 },
  { id: 'comp-auth-svc', name: 'Auth Service', type: 'service', status: 'verified', dependencies: ['comp-user-db'], tokenCost: 6800, changeFrequency: 2, testCoverage: 0.92, traceabilityLinks: { incoming: [{ id: 'tl-1', run_id: 'run-001', source_type: 'component', source_id: 'comp-api-gateway', target_type: 'component', target_id: 'comp-auth-svc', link_type: 'calls', confidence: 0.95 }], outgoing: [{ id: 'tl-2', run_id: 'run-001', source_type: 'component', source_id: 'comp-auth-svc', target_type: 'component', target_id: 'comp-user-db', link_type: 'reads', confidence: 0.9 }] }, governanceEvaluations: [{ id: 'gov-2', run_id: 'run-001', policy_id: 'pol-rbac', policy_name: 'RBAC Policy', status: 'pass', severity: 'info', findings: [], input_data: {} }], artifacts: [{ id: 'art-2', run_id: 'run-001', type: 'openapi', name: 'auth-service-spec.yaml', metadata: {} }], riskScore: 0.05 },
  { id: 'comp-payment-svc', name: 'Payment Service', type: 'service', status: 'tested', dependencies: ['comp-api-gateway', 'comp-fraud-svc', 'comp-ledger-db'], tokenCost: 12400, changeFrequency: 3, testCoverage: 0.78, traceabilityLinks: { incoming: [], outgoing: [{ id: 'tl-3', run_id: 'run-001', source_type: 'component', source_id: 'comp-payment-svc', target_type: 'component', target_id: 'comp-fraud-svc', link_type: 'calls', confidence: 0.85 }, { id: 'tl-4', run_id: 'run-001', source_type: 'component', source_id: 'comp-payment-svc', target_type: 'component', target_id: 'comp-ledger-db', link_type: 'writes', confidence: 0.9 }] }, governanceEvaluations: [{ id: 'gov-3', run_id: 'run-001', policy_id: 'pol-pci', policy_name: 'PCI Compliance', status: 'warn', severity: 'warning', findings: [{ type: 'compliance', message: 'PCI DSS 3.2 gap', requirement_id: 'REQ-001' }], input_data: {} }], artifacts: [{ id: 'art-3', run_id: 'run-001', type: 'doc', name: 'payment-flow.md', metadata: {} }], riskScore: 0.35 },
  { id: 'comp-fraud-svc', name: 'Fraud Detection', type: 'service', status: 'generated', dependencies: ['comp-ml-model', 'comp-transaction-queue'], tokenCost: 8600, changeFrequency: 4, testCoverage: 0.45, traceabilityLinks: { incoming: [{ id: 'tl-3', run_id: 'run-001', source_type: 'component', source_id: 'comp-payment-svc', target_type: 'component', target_id: 'comp-fraud-svc', link_type: 'calls', confidence: 0.85 }], outgoing: [{ id: 'tl-5', run_id: 'run-001', source_type: 'component', source_id: 'comp-fraud-svc', target_type: 'component', target_id: 'comp-ml-model', link_type: 'calls', confidence: 0.7 }] }, governanceEvaluations: [{ id: 'gov-4', run_id: 'run-001', policy_id: 'pol-ml', policy_name: 'ML Model Governance', status: 'fail', severity: 'critical', findings: [{ type: 'governance', message: 'ML model not validated', requirement_id: 'REQ-005' }], input_data: {} }], artifacts: [], riskScore: 0.8 },
  { id: 'comp-reconciliation-svc', name: 'Reconciliation', type: 'service', status: 'tested', dependencies: ['comp-ledger-db', 'comp-payment-svc'], tokenCost: 5200, changeFrequency: 1, testCoverage: 0.72, traceabilityLinks: { incoming: [{ id: 'tl-4', run_id: 'run-001', source_type: 'component', source_id: 'comp-payment-svc', target_type: 'component', target_id: 'comp-ledger-db', link_type: 'writes', confidence: 0.9 }], outgoing: [] }, governanceEvaluations: [], artifacts: [{ id: 'art-4', run_id: 'run-001', type: 'code', name: 'reconciliation-logic.py', metadata: {} }], riskScore: 0.2 },
  { id: 'comp-webhook-svc', name: 'Webhook Service', type: 'service', status: 'tested', dependencies: ['comp-transaction-queue'], tokenCost: 3800, changeFrequency: 1, testCoverage: 0.81, traceabilityLinks: { incoming: [], outgoing: [{ id: 'tl-6', run_id: 'run-001', source_type: 'component', source_id: 'comp-webhook-svc', target_type: 'component', target_id: 'comp-transaction-queue', link_type: 'publishes', confidence: 0.88 }] }, governanceEvaluations: [], artifacts: [{ id: 'art-5', run_id: 'run-001', type: 'code', name: 'webhook-handler.ts', metadata: {} }], riskScore: 0.1 },
  { id: 'comp-dashboard', name: 'Dashboard UI', type: 'frontend', status: 'generated', dependencies: ['comp-api-gateway'], tokenCost: 4600, changeFrequency: 2, testCoverage: 0.35, traceabilityLinks: { incoming: [], outgoing: [{ id: 'tl-7', run_id: 'run-001', source_type: 'component', source_id: 'comp-dashboard', target_type: 'component', target_id: 'comp-api-gateway', link_type: 'calls', confidence: 0.92 }] }, governanceEvaluations: [], artifacts: [{ id: 'art-6', run_id: 'run-001', type: 'code', name: 'dashboard-ui.tsx', metadata: {} }], riskScore: 0.15 },
  { id: 'comp-user-db', name: 'User Database', type: 'database', status: 'verified', dependencies: [], tokenCost: 1200, changeFrequency: 0, testCoverage: 1.0, traceabilityLinks: { incoming: [{ id: 'tl-2', run_id: 'run-001', source_type: 'component', source_id: 'comp-auth-svc', target_type: 'component', target_id: 'comp-user-db', link_type: 'reads', confidence: 0.9 }], outgoing: [] }, governanceEvaluations: [{ id: 'gov-5', run_id: 'run-001', policy_id: 'pol-data', policy_name: 'Data Encryption', status: 'pass', severity: 'info', findings: [], input_data: {} }], artifacts: [{ id: 'art-7', run_id: 'run-001', type: 'sql', name: 'user-schema.sql', metadata: {} }], riskScore: 0 },
  { id: 'comp-ledger-db', name: 'Ledger Database', type: 'database', status: 'verified', dependencies: [], tokenCost: 1400, changeFrequency: 0, testCoverage: 1.0, traceabilityLinks: { incoming: [{ id: 'tl-4', run_id: 'run-001', source_type: 'component', source_id: 'comp-payment-svc', target_type: 'component', target_id: 'comp-ledger-db', link_type: 'writes', confidence: 0.9 }], outgoing: [] }, governanceEvaluations: [{ id: 'gov-6', run_id: 'run-001', policy_id: 'pol-immutable', policy_name: 'Immutable Ledger', status: 'pass', severity: 'info', findings: [], input_data: {} }], artifacts: [{ id: 'art-8', run_id: 'run-001', type: 'sql', name: 'ledger-schema.sql', metadata: {} }], riskScore: 0 },
  { id: 'comp-transaction-queue', name: 'Transaction Queue', type: 'queue', status: 'verified', dependencies: [], tokenCost: 2200, changeFrequency: 0, testCoverage: 0.88, traceabilityLinks: { incoming: [{ id: 'tl-6', run_id: 'run-001', source_type: 'component', source_id: 'comp-webhook-svc', target_type: 'component', target_id: 'comp-transaction-queue', link_type: 'publishes', confidence: 0.88 }], outgoing: [] }, governanceEvaluations: [], artifacts: [{ id: 'art-9', run_id: 'run-001', type: 'config', name: 'queue-config.yaml', metadata: {} }], riskScore: 0.05 },
  { id: 'comp-ml-model', name: 'ML Model', type: 'integration', status: 'blocked', dependencies: [], tokenCost: 3200, changeFrequency: 5, testCoverage: 0.15, traceabilityLinks: { incoming: [{ id: 'tl-5', run_id: 'run-001', source_type: 'component', source_id: 'comp-fraud-svc', target_type: 'component', target_id: 'comp-ml-model', link_type: 'calls', confidence: 0.7 }], outgoing: [] }, governanceEvaluations: [{ id: 'gov-7', run_id: 'run-001', policy_id: 'pol-ml-governance', policy_name: 'ML Model Governance', status: 'fail', severity: 'critical', findings: [{ type: 'governance', message: 'ML model not validated', requirement_id: 'REQ-005' }], input_data: {} }], artifacts: [], riskScore: 0.85 },
  { id: 'comp-notification-cache', name: 'Notification Cache', type: 'cache', status: 'verified', dependencies: [], tokenCost: 800, changeFrequency: 0, testCoverage: 0.9, traceabilityLinks: { incoming: [], outgoing: [] }, governanceEvaluations: [], artifacts: [{ id: 'art-10', run_id: 'run-001', type: 'config', name: 'cache-config.yaml', metadata: {} }], riskScore: 0.05 },
];
